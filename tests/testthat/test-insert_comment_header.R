...
#     # fuzz test 'author'
#     fuzz_author <- fuzz_function(insert_comment_header,
#                                  arg_name = "author", target = "none", tests = test_all())
#
#     # fuzz test 'email'
#     fuzz_email <- fuzz_function(insert_comment_header,
#                                 arg_name = "email", target = "none", tests = test_all())
#
#     # fuzz test 'header'
#     fuzz_header <- fuzz_function(insert_comment_header,
#                                  arg_name = "header", target = "none", tests = test_all())
#
#     # fuzz test 'description'
#     fuzz_description <- fuzz_function(insert_comment_header,
#                                       arg_name = "description", target = "none", tests = test_all())
#
#     # check fuzz results
